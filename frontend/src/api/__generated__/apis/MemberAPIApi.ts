...
export class MemberAPIApi extends runtime.BaseAPI {
     ...
     * 로그인
     */
    async loginRaw(requestParameters: LoginOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataLoginResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RsDataLoginResponseFromJSON(jsonValue));
    }

    /**
     * 로그인
     */
    async login(requestParameters: LoginOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RsDataLoginResponse> {
     ...
     * 로그아웃
     */
    async logoutRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataObject>> {
        const queryParameters: any = {};
     ...
     * 로그아웃
     */
    async logout(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RsDataObject> {
     ...
     * 내 정보 조회
     */
    async myInfoRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataMemberDetailResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RsDataMemberDetailResponseFromJSON(jsonValue));
    }
     ...
     * 회원탈퇴
     */
    async signoutRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataObject>> {
        const queryParameters: any = {};
     ...
     * 회원탈퇴
     */
    async signout(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RsDataObject> {
     ...
     * 회원가입
     */
    async signupRaw(requestParameters: SignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataMemberDetailResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MemberCreateRequestToJSON(requestParameters['memberCreateRequest']),
        }, initOverrides);
     ...
     * 회원가입
     */
    async signup(requestParameters: SignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RsDataMemberDetailResponse> {
     ...
     * 내 정보 수정
     */
    async updateMyInfoRaw(requestParameters: UpdateMyInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataMemberDetailResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MemberUpdateRequestToJSON(requestParameters['memberUpdateRequest']),
        }, initOverrides);
     ...
     * 내 정보 수정
     */
    async updateMyInfo(requestParameters: UpdateMyInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RsDataMemberDetailResponse> {
        const response = await this.updateMyInfoRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * 비밀번호 변경
     */
    async updatePasswordRaw(requestParameters: UpdatePasswordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RsDataObject>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MemberPasswordUpdateRequestToJSON(requestParameters['memberPasswordUpdateRequest']),
        }, initOverrides);
