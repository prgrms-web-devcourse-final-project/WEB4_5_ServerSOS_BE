...
export function ApplicationContextClassLoaderParentUnnamedModuleFromJSON(
  ...
  return ApplicationContextClassLoaderParentUnnamedModuleFromJSONTyped(
    json,
    false,
  )
}
...
export function ApplicationContextClassLoaderParentUnnamedModuleFromJSONTyped(
  ...
  return {
    ...
    nativeAccessEnabled:
      json["nativeAccessEnabled"] == null
        ? undefined
        : json["nativeAccessEnabled"],
...
export function ApplicationContextClassLoaderParentUnnamedModuleToJSON(
  ...
  return ApplicationContextClassLoaderParentUnnamedModuleToJSONTyped(
    json,
    false,
  )
}
...
export function ApplicationContextClassLoaderParentUnnamedModuleToJSONTyped(
  ...
  return {
    ...
    packages:
      value["packages"] == null
        ? undefined
        : Array.from(value["packages"] as Set<any>),
