...
export type BaseLogResponseActorTypeEnum =
  (typeof BaseLogResponseActorTypeEnum)[keyof typeof BaseLogResponseActorTypeEnum]
...
export type BaseLogResponseActionEnum =
  (typeof BaseLogResponseActionEnum)[keyof typeof BaseLogResponseActionEnum]

/**
 * Check if a given object implements the BaseLogResponse interface.
 */
export function instanceOfBaseLogResponse(
  value: object,
): value is BaseLogResponse {
  return true
}
...
export function BaseLogResponseFromJSONTyped(
  json: any,
...
export function BaseLogResponseToJSONTyped(
  value?: BaseLogResponse | null,
