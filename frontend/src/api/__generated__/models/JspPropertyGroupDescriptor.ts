...
export function JspPropertyGroupDescriptorFromJSON(
  json: any,
...
export function JspPropertyGroupDescriptorFromJSONTyped(
  ...
  return {
    ...
    errorOnELNotFound:
      json["errorOnELNotFound"] == null ? undefined : json["errorOnELNotFound"],
    pageEncoding:
      json["pageEncoding"] == null ? undefined : json["pageEncoding"],
    scriptingInvalid:
      json["scriptingInvalid"] == null ? undefined : json["scriptingInvalid"],
    isXml: json["isXml"] == null ? undefined : json["isXml"],
    includePreludes:
      json["includePreludes"] == null ? undefined : json["includePreludes"],
    includeCodas:
      json["includeCodas"] == null ? undefined : json["includeCodas"],
    trimDirectiveWhitespaces:
      json["trimDirectiveWhitespaces"] == null
        ? undefined
        : json["trimDirectiveWhitespaces"],
    errorOnUndeclaredNamespace:
      json["errorOnUndeclaredNamespace"] == null
        ? undefined
        : json["errorOnUndeclaredNamespace"],
    defaultContentType:
      json["defaultContentType"] == null
        ? undefined
        : json["defaultContentType"],
    buffer: json["buffer"] == null ? undefined : json["buffer"],
    urlPatterns: json["urlPatterns"] == null ? undefined : json["urlPatterns"],
  }
}

export function JspPropertyGroupDescriptorToJSON(
  json: any,
): JspPropertyGroupDescriptor {
