...
export type MemberLogResponseAuthorityEnum = typeof MemberLogResponseAuthorityEnum[keyof typeof MemberLogResponseAuthorityEnum];
...
export type MemberLogResponseSocialProviderEnum = typeof MemberLogResponseSocialProviderEnum[keyof typeof MemberLogResponseSocialProviderEnum];


/**
 * Check if a given object implements the MemberLogResponse interface.
 */
export function instanceOfMemberLogResponse(value: object): value is MemberLogResponse {
    return true;
}
...
export function MemberLogResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberLogResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function MemberLogResponseToJSONTyped(value?: MemberLogResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
