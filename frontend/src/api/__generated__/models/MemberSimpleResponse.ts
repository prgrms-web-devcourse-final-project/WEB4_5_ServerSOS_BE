...
export type MemberSimpleResponseAuthorityEnum = typeof MemberSimpleResponseAuthorityEnum[keyof typeof MemberSimpleResponseAuthorityEnum];


/**
 * Check if a given object implements the MemberSimpleResponse interface.
 */
export function instanceOfMemberSimpleResponse(value: object): value is MemberSimpleResponse {
    return true;
}
...
export function MemberSimpleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberSimpleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function MemberSimpleResponseToJSONTyped(value?: MemberSimpleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
