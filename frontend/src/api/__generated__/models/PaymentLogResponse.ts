...
export type PaymentLogResponseStatusEnum = typeof PaymentLogResponseStatusEnum[keyof typeof PaymentLogResponseStatusEnum];


/**
 * Check if a given object implements the PaymentLogResponse interface.
 */
export function instanceOfPaymentLogResponse(value: object): value is PaymentLogResponse {
    return true;
}
...
export function PaymentLogResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentLogResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'paymentTime': json['paymentTime'] == null ? undefined : (new Date(json['paymentTime'])),
...
export function PaymentLogResponseToJSONTyped(value?: PaymentLogResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'amount': value['amount'],
        'status': value['status'],
        'paymentTime': value['paymentTime'] == null ? undefined : ((value['paymentTime']).toISOString()),
