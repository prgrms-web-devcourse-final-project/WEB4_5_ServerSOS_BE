...
export type PaymentSimpleResponsePaymentStatusEnum = typeof PaymentSimpleResponsePaymentStatusEnum[keyof typeof PaymentSimpleResponsePaymentStatusEnum];


/**
 * Check if a given object implements the PaymentSimpleResponse interface.
 */
export function instanceOfPaymentSimpleResponse(value: object): value is PaymentSimpleResponse {
    return true;
}

export function PaymentSimpleResponseFromJSON(json: any): PaymentSimpleResponse {
    return PaymentSimpleResponseFromJSONTyped(json, false);
}

export function PaymentSimpleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentSimpleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PaymentSimpleResponseToJSONTyped(value?: PaymentSimpleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
