 ...
 */
export function instanceOfPerformanceDetailResponse(value: object): value is PerformanceDetailResponse {
    return true;
}

export function PerformanceDetailResponseFromJSON(json: any): PerformanceDetailResponse {
    return PerformanceDetailResponseFromJSONTyped(json, false);
}

export function PerformanceDetailResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PerformanceDetailResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PerformanceDetailResponseToJSON(json: any): PerformanceDetailResponse {
    return PerformanceDetailResponseToJSONTyped(json, false);
}

export function PerformanceDetailResponseToJSONTyped(value?: PerformanceDetailResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
