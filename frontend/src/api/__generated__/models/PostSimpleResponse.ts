 ...
 */
export function instanceOfPostSimpleResponse(value: object): value is PostSimpleResponse {
    return true;
}
...
export function PostSimpleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostSimpleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PostSimpleResponseToJSONTyped(value?: PostSimpleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
