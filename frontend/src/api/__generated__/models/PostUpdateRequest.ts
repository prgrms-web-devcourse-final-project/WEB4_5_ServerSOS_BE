 ...
 */
export function instanceOfPostUpdateRequest(value: object): value is PostUpdateRequest {
    return true;
}
...
export function PostUpdateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostUpdateRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'performance': json['performance'] == null ? undefined : PerformanceUpdateRequestFromJSON(json['performance']),
    };
}
...
export function PostUpdateRequestToJSONTyped(value?: PostUpdateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
