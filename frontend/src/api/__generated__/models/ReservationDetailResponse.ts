...
export type ReservationDetailResponseStatusEnum =
  (typeof ReservationDetailResponseStatusEnum)[keyof typeof ReservationDetailResponseStatusEnum]

/**
 * Check if a given object implements the ReservationDetailResponse interface.
 */
export function instanceOfReservationDetailResponse(
  value: object,
): value is ReservationDetailResponse {
  return true
}

export function ReservationDetailResponseFromJSON(
  json: any,
): ReservationDetailResponse {
  return ReservationDetailResponseFromJSONTyped(json, false)
}

export function ReservationDetailResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    performance:
      json["performance"] == null
        ? undefined
        : PerformanceInfoFromJSON(json["performance"]),
    session:
      json["session"] == null
        ? undefined
        : PerformanceSessionInfoFromJSON(json["session"]),
...
export function ReservationDetailResponseToJSON(
  json: any,
): ReservationDetailResponse {
  return ReservationDetailResponseToJSONTyped(json, false)
}

export function ReservationDetailResponseToJSONTyped(
  value?: ReservationDetailResponse | null,
