 ...
 */
export function instanceOfReservationLogResponse(
  value: object,
): value is ReservationLogResponse {
  return true
}

export function ReservationLogResponseFromJSON(
  json: any,
): ReservationLogResponse {
  return ReservationLogResponseFromJSONTyped(json, false)
}

export function ReservationLogResponseFromJSONTyped(
  json: any,
...
export function ReservationLogResponseToJSON(
  json: any,
): ReservationLogResponse {
  return ReservationLogResponseToJSONTyped(json, false)
}

export function ReservationLogResponseToJSONTyped(
  value?: ReservationLogResponse | null,
