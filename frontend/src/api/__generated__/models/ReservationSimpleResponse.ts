...
export type ReservationSimpleResponseStatusEnum = typeof ReservationSimpleResponseStatusEnum[keyof typeof ReservationSimpleResponseStatusEnum];


/**
 * Check if a given object implements the ReservationSimpleResponse interface.
 */
export function instanceOfReservationSimpleResponse(value: object): value is ReservationSimpleResponse {
    return true;
}

export function ReservationSimpleResponseFromJSON(json: any): ReservationSimpleResponse {
    return ReservationSimpleResponseFromJSONTyped(json, false);
}

export function ReservationSimpleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationSimpleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ReservationSimpleResponseToJSON(json: any): ReservationSimpleResponse {
    return ReservationSimpleResponseToJSONTyped(json, false);
}

export function ReservationSimpleResponseToJSONTyped(value?: ReservationSimpleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
