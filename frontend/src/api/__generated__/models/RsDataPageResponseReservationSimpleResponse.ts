 ...
 */
export function instanceOfRsDataPageResponseReservationSimpleResponse(value: object): value is RsDataPageResponseReservationSimpleResponse {
    return true;
}

export function RsDataPageResponseReservationSimpleResponseFromJSON(json: any): RsDataPageResponseReservationSimpleResponse {
    return RsDataPageResponseReservationSimpleResponseFromJSONTyped(json, false);
}

export function RsDataPageResponseReservationSimpleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RsDataPageResponseReservationSimpleResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : PageResponseReservationSimpleResponseFromJSON(json['data']),
    };
}

export function RsDataPageResponseReservationSimpleResponseToJSON(json: any): RsDataPageResponseReservationSimpleResponse {
    return RsDataPageResponseReservationSimpleResponseToJSONTyped(json, false);
}

export function RsDataPageResponseReservationSimpleResponseToJSONTyped(value?: RsDataPageResponseReservationSimpleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
